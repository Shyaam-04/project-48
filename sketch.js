...
var explosion, bgMusic,danger_alarm;
var v1,v1Img,v2,v2Img,v3,v3Img,v4,v4Img;
var PC,PCImg;
var player,enemy,enemyGroup,enemyImg;
var astronaut;
...
function  preload(){
 ...
 /* v1Img=loadImage("sprites/villain1 (1).png");
  ...
  danger_alarm=loadSound("music/mixkit-facility-alarm-sound-999.wav");
 // astronaut = loadImage("sprites/astronaut.png");
 enemyImg = loadImage("sprites/enemy1.png");
...
function attackShipTop(){ 
  ...
  jetUp = createSprite(random(300,1000),0); 
...
function attackShipDown(){
    ...
    if((frameCount+50)%200==0){
        jetDown = createSprite(random(300,1000),windowHeight);
